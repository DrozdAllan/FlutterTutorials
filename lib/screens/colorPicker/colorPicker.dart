...
class ColorPickerTuto extends StatefulWidget {
  static const routeName = '/colorPicker';

  const ColorPickerTuto({Key? key}) : super(key: key);

  @override
  _ColorPickerTutoState createState() => _ColorPickerTutoState();
}

class _ColorPickerTutoState extends State<ColorPickerTuto> {
                ...
                children: <Widget>[
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      onPrimary: useWhiteForeground(currentColor)
