...
class FlashTuto extends StatefulWidget {
  const FlashTuto({Key? key}) : super(key: key);
  static const routeName = '/flashTuto';

  @override
  _FlashTutoState createState() => _FlashTutoState();
}

class _FlashTutoState extends State<FlashTuto> {
